...
Three mods for Wolfpack (pre-beta, IL2CPP). Requires BepInEx 6 IL2CPP.
---
GT-LogbookExport
...
---
Installation
Install BepInEx 6 IL2CPP into the Wolfpack game folder
Drop the `.dll` files into `BepInEx/plugins/`
Launch the game
Requirements
